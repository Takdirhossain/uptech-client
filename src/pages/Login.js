...
const Login = () => {
   useTitle("Login")
    ...
    const handaleFacebookLogin = () => {
        singUpWithFacebook(facebookProvider)
            .then(result => {
    ...
    const handaleLoginWithEmail = () => {
        singupWithGoogle(provider)
        .then(()=>{
                    ...
                    <div class="container mx-auto">
                        <div class="-mx-4 flex flex-wrap">
                            <div class="w-full  px-4">
                                <div
                                    class="shadow-lg relative mx-auto max-w-[525px] overflow-hidden rounded-lg bg-white py-16 px-10 text-center sm:px-12 md:px-[60px]"
                                >
                                    ...
                                    <form onSubmit={handaleLogin} >
                                        ...
                                        <div class="mb-10">
                                            ...
                                            <button class="btn bg-blue bordder-primary w-full cursor-pointer rounded-md border bg-silver py-3 px-5 text-base text-white transition hover:bg-opacity-90 font-bold">login</button>
                                        </div>
                                        <p className='text-dark'>{error }</p>
                                    </form>
                                    <p class="mb-6 text-base text-[#adadad]">Connect With</p>
                                    <ul class="-mx-2 mb-12 flex justify-between">
                                        <li onClick={handaleFacebookLogin} class="w-full px-2">
                                            <Link
                                        ...
                                        <li onClick={handaleLoginWithEmail} class="w-full px-2">
                                            <Link
